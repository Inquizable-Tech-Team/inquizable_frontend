    ...
    <div>
      <div className="w-80vw Info-Box mx-auto">
        ...
        <div className="md:w-3/5 lg:w-3/4 mt-4 InfoBox pl-4 pr-4 pt-4 pb-4 mx-auto xs:w-full">
          <p>Welcome to Inquizable.com!</p>

          <p>
            These terms and conditions outline the rules and regulations for the
            use of Inquizable's Website, located at https://www.inquizable.com/.
          </p>

          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use Inquizable.com if you do not
      ...
      <div className="w-80vw Info-Box mx-auto">
        <h3 className="mt-5 xs:text-center sm:text-center">
      ...
      <div className="w-80vw Info-Box mx-auto">
        ...
        <div className="md:w-3/5 lg:w-3/4 mt-4 InfoBox pl-4 pr-4 pt-4 pb-4 mx-auto xs:w-full">
          <p>
            Unless otherwise stated, Inquizable and/or its licensors own the
            intellectual property rights for all material on Inquizable.com. All
            intellectual property rights are reserved. You may access this from
            Inquizable.com for your own personal use subjected to restrictions
            set in these terms and conditions.
          </p>

          <p>You must not:</p>
          <ul>
            <li>Republish material from Inquizable.com</li>
            <li>Sell, rent or sub-license material from Inquizable.com</li>
            <li>Reproduce, duplicate or copy material from Inquizable.com</li>
            <li>Redistribute content from Inquizable.com</li>
          </ul>
          ...
          <p>
            ...
            Inquizable does not filter, edit, publish or review Comments prior
            to their presence on the website. Comments do not reflect the views
            and opinions of Inquizable,its agents and/or affiliates. Comments
            reflect the views and opinions of the person who post their views
            and opinions. To the extent permitted by applicable laws, Inquizable
          ...
          <p>
            Inquizable reserves the right to monitor all Comments and to remove
          ...
          <p>
            You hereby grant Inquizable a non-exclusive license to use,
      ...
      <div className="w-80vw Info-Box mx-auto">
        ...
        <div className="md:w-3/5 lg:w-3/4 mt-4 InfoBox pl-4 pr-4 pt-4 pb-4 mx-auto xs:w-full">
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of Inquizable;
          ...
          <p>
            ...
            sending an e-mail to Inquizable. Please include your name, your
          ...
          <p>
            No use of Inquizable's logo or other artwork will be allowed for
      ...
      <div className="md:w-3/5 lg:w-3/4 mt-4 InfoBox pl-4 pr-4 pt-4 pb-4 mx-auto xs:w-full mb-12">
