      ...
      <div className="mx-auto w-full max-w-sm lg:w-96">
        ...
        <div className="mt-8">
          <div className="mt-6">
            ...
            <h3 className="xs:text-left sm:text-left md:text-left text-gray-700">You can register here:</h3>
            <div>
            ...
            <div className="mt-1">
              ...
              <h3 className="xs:text-left sm:text-left md:text-left text-gray-700 mt-5 mb-5">You can log in here:</h3>
