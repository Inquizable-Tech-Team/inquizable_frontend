...
export const Login = () => {
    ...
    return (
      ...
      <img className="absolute inset-0 h-full w-full object-cover" src="https://i.ibb.co/BtphtMg/brain.jpg" alt=""/>
    </div>
    <div className="flex-1 flex flex-col justify-center py-12 px-4 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
      <div className="mx-auto w-full max-w-sm lg:w-96">
        <div>
          <img  src="https://i.ibb.co/r3Pr5f0/Screenshot-2021-06-13-171142.png" alt="Workflow"/>
        </div>
        <div className="mt-8">
          <div className="mt-6">
            ...
            <div className="mt-1">
              ...
              <div>
                <button action="/login" method="POST" type="submit" className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                  Register
                </button>
              </div>
              <div>
